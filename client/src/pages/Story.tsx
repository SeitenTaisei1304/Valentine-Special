  ...
  const sortedStory = [
    {
      ...
      content: "From the first text till the last argument, I never knew what was extraordinary about you that made me so inclined towards you. Time seemed to stand still, everything felt nice, real and right & everything changed.",
      imageUrl: "/HER 2.jpg",
      order: 1
    },
    {
      ...
      imageUrl: "/US TOGETHER.jpg",
      order: 2
    },
    {
      id: 3,
      title: "Falling Deeper",
      content: "Somewhere along the way, my liking blossomed into something more. My heart would race at the sound of your voice, and your smile became my favorite sight.",
      imageUrl: "/US again.jpeg",
      order: 3
    },
  ];
